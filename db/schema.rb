...
ActiveRecord::Schema[8.0].define(version: 2025_04_30_235257) do
  ...
  create_table "domains", force: :cascade do |t|
    ...
    t.bigint "user_id", null: false
    t.string "name"
    t.boolean "collects_desktop", default: false, null: false
    t.boolean "collects_mobile", default: false, null: false
